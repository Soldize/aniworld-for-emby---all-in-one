...
show_guide() {
    ...
    echo -e "  - ${CYAN}Status${NC} aller Services (online/offline)"
    echo -e "  - ${CYAN}Sync${NC} manuell starten/stoppen mit Live-Log"
    echo -e "  - ${CYAN}Detail Scrape${NC}:"
    echo "      🔄 Batch Scrape  - alle ungescrapten Anime auf einmal"
    echo "      🔍 Einzeln       - einen Anime-Slug eingeben und nur den scrapen"
    echo -e "  - ${CYAN}Config${NC} direkt im Browser bearbeiten und speichern"
    echo ""
